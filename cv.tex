...
\cventry{Sep 2021 - now}{Software Engineer}{Google LLC}{Meaning Representation}{}{
	\begin{itemize}
		\item{Working on meaning schemes deduplication mechanism for intermediate language between natural language and database queries.}
	\end{itemize}
}
\cventry{July 2018 - Sep 2021}{Software Engineer}{Google Switzerland}{Algorithmic Reconciliation for Knowledge Engine}{}{
	\begin{itemize}
